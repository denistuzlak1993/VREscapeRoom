...
struct U3CPrivateImplementationDetailsU3E_t6884355282165D4E80B093E8026110DAC79B4BC8_StaticFields
{
	...
	__StaticArrayInitTypeSizeU3D50703_tB29AB167F62C3C71BC74D8B54C21B8A49664EFC6 ___18DBE7FFE0D5DFA94C94437F1FDB1B11AE49A7E63D6C2BCCB8936A1A55337B3B;
...
IL2CPP_MANAGED_FORCE_INLINE IL2CPP_METHOD_ATTR bool ReticleDataTeleport_get_HideReticle_mB48CC7F1FAC01F625123D563860084EA5308CCA8_inline (ReticleDataTeleport_t359262752069B0F4BBD5C382EEF4F58B3D0E859B* __this, const RuntimeMethod* method) ;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 HandGrabAPI_GetPinchCenter_m661D263F3C12107ECF5B7EC45558E60DFC55AF1D (HandGrabAPI_tC01EECBC2ADA4AC37EC064B470A93CBD44CB8787* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		NullCheck(L_2);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_3;
		L_3 = InterfaceFuncInvoker0< Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 >::Invoke(3, IFingerAPI_tBA85AFE7CC89405D79B0FADB2993D326FF08B209_il2cpp_TypeInfo_var, L_2);
		V_0 = L_3;
	}
...
IL_001a:
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_5;
		L_5 = HandGrabAPI_WristOffsetToWorldPoint_mBB6C13E0BA2C62676646899435F3F3AD0201681F(__this, L_4, NULL);
		return L_5;
	}
}
...
IL_0016:
	{
		...
		NullCheck(L_5);
		bool L_6;
		L_6 = ReticleDataTeleport_get_HideReticle_mB48CC7F1FAC01F625123D563860084EA5308CCA8_inline(L_5, NULL);
		if (!L_6)
		{
			goto IL_0027;
		}
...
IL_0027:
	{
		...
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_10;
		L_10 = TeleportHit_get_Point_mA410290D272135B53FDB860D1DF4195CF18411D0((&V_6), NULL);
		NullCheck(L_7);
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_11;
		...
		V_6 = L_13;
		Vector3_t24C512C7B96BBABAD472002D0BA2BDA40A5A80B2 L_14;
		L_14 = TeleportHit_get_Normal_m80A0655F5E20349258BB9D1BF067A2CE5A9C6977((&V_6), NULL);
...
IL_0083:
	{
		V_3 = G_B8_0;
		TeleportInteractor_t6EE85FB9D37B68FA7C45EE1DA150B20DBA00D9FC* L_22 = __this->____interactor;
		NullCheck(L_22);
		bool L_23;
		L_23 = TeleportInteractor_HasValidDestination_m3A27912052BA982E74B4B2A3120AF39D823869BE(L_22, NULL);
		V_4 = L_23;
		...
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_26 = __this->____invalidTargetRenderer;
		bool L_27 = V_4;
		NullCheck(L_26);
		Renderer_set_enabled_m015E6D7B825528A31182F267234CC6A925F71DA8(L_26, (bool)((((int32_t)L_27) == ((int32_t)0))? 1 : 0), NULL);
		bool L_28 = V_4;
		if (L_28)
		{
			goto IL_00ba;
	...
	{
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_29 = __this->____invalidTargetRenderer;
		G_B11_0 = L_29;
		goto IL_00c0;
	}
...
IL_00ba:
	{
		Renderer_t320575F223BCB177A982E5DDB5DB19FAA89E7FBF* L_30 = __this->____validTargetRenderer;
		G_B11_0 = L_30;
	}
...
IL_00c0:
	{
		...
		float L_32 = V_3;
		TeleportReticleDrawer_SetReticleProgress_m3870C0C3FA0B16F2F755DAB44EB0A9A604F671B3(__this, L_31, L_32, NULL);
		RuntimeObject* L_33 = __this->___HighlightState;
		if (!L_33)
		{
			goto IL_00dc;
		}
	}
	{
		...
		bool L_35 = V_0;
		TeleportReticleDrawer_SetReticleHighlight_m69FBC72A3C86FFA89823B4D7EE551E43585F4EC1(__this, L_34, L_35, NULL);
	}
